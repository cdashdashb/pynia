...
backend = usb.backend.libusb1.get_backend(
    find_library=lambda x: "T:/Programming Stuff/Python Projects/OCZ nia/libusb-1.0.dll"
)
...
class NiaData():
    ...
    def __init__(self, nia, milliseconds):
        self.Points = int(milliseconds / 2)  # Truncate to integer
